 ...
 *
 * Usage: deno run -A dev/build-page.ts <pagesDir> <route> <outDir> [basePath]
 *
...
async function main(): Promise<void> {
  ...
  const [pagesDir, route, outDir, basePath = ""] = args;
  ...
  try {
    const result = await buildPage(pagesDir, route, outDir, basePath);
